...
def load_cluster_labels(suffix, results_dir='results/clustering'):
    """
...
def load_cluster_data(suffix, results_dir='results/clustering'):
    """
...
def get_clustering_summary(results_dir='results/clustering'):
    """
