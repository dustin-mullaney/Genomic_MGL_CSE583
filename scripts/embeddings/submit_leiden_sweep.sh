#!/bin/bash
#SBATCH --job-name=leiden_sweep
#SBATCH --output=logs/leiden_sweep_%A_%a.out
#SBATCH --error=logs/leiden_sweep_%A_%a.err
#SBATCH --array=0-89
...
# Comprehensive Leiden clustering parameter sweep
# - Resolutions: 5, 10, 20, 50, 100, 200, 300, 400, 500
...
echo "=========================================="
echo "Leiden Clustering Parameter Sweep"
echo "Task: ${SLURM_ARRAY_TASK_ID}/90"
echo "=========================================="
