...
mkdir -p "${PROJECT_DIR}/results/plots/cog_categories"
...
echo ""
echo "Script: ${SCRIPT}"
echo "Output: ${PROJECT_DIR}/results/plots/cog_categories/"
echo ""
...
if [ ${EXIT_CODE} -eq 0 ]; then
    ...
    echo "Output directory: ${PROJECT_DIR}/results/plots/cog_categories/"
else
