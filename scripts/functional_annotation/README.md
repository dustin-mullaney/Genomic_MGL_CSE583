...
python scripts/functional_annotation/plot_cog_umap.py \
    --umap results/umap/umap_n15_subsample100000.npz \
    --cog-metadata results/metadata/cog_annotations \
    --output results/umap/umap_cog_visualization.png
```
...
python scripts/functional_annotation/plot_cog_umap.py \
    --umap results/umap/umap_n15_subsample100000.npz \
    --cog-metadata results/metadata/cog_annotations \
    --output results/umap/umap_n15_cog_visualization.png

# 5. Try different UMAP parameters - just reuse the same metadata!
python scripts/functional_annotation/plot_cog_umap.py \
    --umap results/umap/umap_n50_subsample100000.npz \
    --cog-metadata results/metadata/cog_annotations \
    --output results/umap/umap_n50_cog_visualization.png
```
...
```bash
python scripts/functional_annotation/plot_cog_umap.py \
    --annotated-umap results/umap/umap_n15_with_cogs.csv \
    --output results/umap/umap_cog_visualization.png \
...
```bash
# From UMAP
python -c "import numpy as np; d=np.load('results/umap/umap_n15.npz', allow_pickle=True); print(d['gene_ids'][0])"
