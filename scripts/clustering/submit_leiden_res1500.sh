#!/bin/bash
#SBATCH --job-name=leiden_1500
#SBATCH --output=logs/leiden_1500_%A_%a.out
#SBATCH --error=logs/leiden_1500_%A_%a.err
#SBATCH --array=0-9
...
# Resolution 1500 Leiden clustering
# - Resolution: 1500
...
# Total configs: 1 × 5 × 2 = 10
N_NEIGHBORS_VALS=${#N_NEIGHBORS[@]}
N_VERSIONS=${#VERSIONS[@]}

# Calculate which config this task is
NEIGHBORS_IDX=$((SLURM_ARRAY_TASK_ID / N_VERSIONS))
...
echo "=========================================="
echo "Resolution 1500 Leiden Clustering"
