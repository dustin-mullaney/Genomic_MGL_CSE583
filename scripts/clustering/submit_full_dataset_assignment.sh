...
CLUSTERING_FILE="${PROJECT_DIR}/results/clustering/clusters_leiden_res1500_nn15_cogonly.npz"
...
OUTPUT_FILE="${PROJECT_DIR}/results/clustering/full_dataset_assignments_res1500_nn15_cogonly.npz"
