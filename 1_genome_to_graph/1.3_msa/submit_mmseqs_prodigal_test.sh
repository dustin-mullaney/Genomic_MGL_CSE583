#!/bin/bash
#SBATCH --job-name=mmseqs_prodigal
#SBATCH --output=logs/mmseqs_prodigal_%j.out
#SBATCH --error=logs/mmseqs_prodigal_%j.err
#SBATCH --time=2:00:00
#SBATCH --mem=32G
#SBATCH --cpus-per-task=8
#SBATCH --partition=campus-new

# MMseqs2 clustering on Prodigal proteins (correct gene ID format)

echo "========================================="
echo "MMseqs2 on Prodigal Proteins"
echo "========================================="
...
# Set parameters
INPUT_FASTA="data/prodigal_test_50genomes.faa"
OUTPUT_DIR="data/mmseqs_prodigal_test"
MIN_SEQ_ID=0.5
COVERAGE=0.8
THREADS=8
