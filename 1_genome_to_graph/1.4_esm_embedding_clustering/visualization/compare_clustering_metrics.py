...
def load_homogeneity_metrics():
    ...
    csv_file = Path('results/1_genome_to_graph/1.4_esm_embedding_clustering/clustering/leiden_sweep_summary.csv')
...
def load_quality_metrics():
    ...
    csv_file = Path('results/1_genome_to_graph/1.4_esm_embedding_clustering/clustering/quality_metrics_comprehensive.csv')
    if not csv_file.exists():
        print(f"Warning: {csv_file} not found")
        return None
...
def load_stability_metrics():
    ...
    stability_dir = Path('results/1_genome_to_graph/1.4_esm_embedding_clustering/clustering/stability')
...
def plot_metric_comparison(df, output_dir='results/1_genome_to_graph/1.4_esm_embedding_clustering/plots/metric_comparison'):
...
def main():
    ...
    output_file = Path('results/1_genome_to_graph/1.4_esm_embedding_clustering/clustering/all_metrics_combined.csv')
